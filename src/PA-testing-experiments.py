...
def gen_figure_1() -> None:
    ...
    for market, r_over_c in R_OVER_C_VALUES.items():
        ...
        filename = "1a.pdf" if is_small_market else "1b.pdf"
...
def gen_figure_3() -> None:
    ...
    save_panel_3a(Path("3a.pdf"), top_terminal)
    save_panel_3b(Path("3b.pdf"), top_terminal)

    curves = compute_profit_curves()
    save_profit_panel(Path("3c.pdf"), 1.0, curves[1.0], "(c)")
    save_profit_panel(Path("3d.pdf"), 5.0, curves[5.0], "(d)")
